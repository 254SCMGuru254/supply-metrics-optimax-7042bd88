...
const CenterOfGravity = () => {
  ...
  const handleOptimize = () => {
    ...
    toast({
      ...
      description: "Network has been optimized using Center of Gravity method.",
    });
  };
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Optimize facility locations based on weighted distances and demand points.
          </p>
        </div>
            ...
            {isOptimized && (
              <>
                ...
                <div>
                  ...
                  <p className="text-2xl font-semibold text-primary">22%</p>
                </div>
              </>
            )}
          </div>
      ...
      <Card className="p-4">
        ...
        <div className="space-y-2">
          ...
          <p>3. Click "Run Optimization" to calculate optimal facility locations</p>
