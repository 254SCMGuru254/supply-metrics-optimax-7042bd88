...
export const RouteOptimizationAdvanced: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50" id="advanced-route-optimization">
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-gray-800">
            Advanced Route Optimization Suite
          </h1>
          <p className="text-gray-500 mt-1">
            Build, simulate, and optimize complex vehicle routing scenarios.
          </p>
        </div>
      </header>
      <main className="container mx-auto p-2 md:py-6 space-y-6">
        <Card>
          <CardHeader>
...
export default RouteOptimizationAdvanced;
