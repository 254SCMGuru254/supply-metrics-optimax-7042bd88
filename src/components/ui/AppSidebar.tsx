  ...
  return (
    <div className="h-screen flex flex-col border-r">
      ...
      <nav className="space-y-1 px-2 py-5 flex-grow overflow-y-auto">
        ...
        <Link to="/center-of-gravity" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <Settings className="mr-3 h-5 w-5 text-muted-foreground" />
          Center of Gravity
        </Link>
        <Link to="/facility-location" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <Settings className="mr-3 h-5 w-5 text-muted-foreground" />
          Facility Location
        </Link>
        <Link to="/network-optimization" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <BarChart3 className="mr-3 h-5 w-5 text-muted-foreground" />
          Network Optimization
        </Link>
        <Link to="/route-optimization" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <Truck className="mr-3 h-5 w-5 text-muted-foreground" />
          Route Optimization
        </Link>
        <Link to="/heuristic" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <HelpCircle className="mr-3 h-5 w-5 text-muted-foreground" />
          Heuristic
        </Link>
        <Link to="/simulation" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <Activity className="mr-3 h-5 w-5 text-muted-foreground" />
          Simulation
        </Link>
        <Link to="/risk-management" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <Shield className="mr-3 h-5 w-5 text-muted-foreground" />
          Risk Management
        </Link>
        <Link to="/cost-modeling" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <CircleDollarSign className="mr-3 h-5 w-5 text-muted-foreground" />
          Cost Modeling
        </Link>
        <Link to="/fleet-management" className="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-muted group">
          <Truck className="mr-3 h-5 w-5 text-muted-foreground" />
          Fleet Management
        </Link>
        <div className="px-2 py-2 text-xs font-bold text-muted-foreground uppercase">
